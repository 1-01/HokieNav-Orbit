function T = R1(x, angleUnit)
% 
% Matt Werner (m.werner@vt.edu) - Dec 23, 2020
% Matt Werner (m.werner@vt.edu) - May 26, 2020
% 
...
% rotated a positive (counterclockwise) angle x about the common 1-axis of
...
%                     is rotated about the two shared 1-axes of the two
...
% 
%                    "degrees" - Specifies that the given angle x is in
%                                terms of degrees.
% 
%    Outputs:
% 
%                 T - Rotation matrix to convert the expression of any
%                     vector from an original frame to a new frame whose
%                     basis elements are rotated a positive angle x about
%                     the common 1-axis of the two frames.
%                     Size: 3-by-3 (matrix)
%                     Units: - (unitless)
% 
...
% Define the 1-rotation
T = [1, 0, 0; 0, cosx, sinx; 0, -sinx, cosx];