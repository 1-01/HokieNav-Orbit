...
% rotated a positive (counterclockwise) angle x about the common 2-axis of
...
%                     is rotated about the two shared 2-axes of the two
...
%                     the common 2-axis of the two frames.
%                     Size: 3-by-3 (matrix)
%                     Units: - (N/A)
% 
...
% Define the 2-rotation
T = [cosx, 0, -sinx; 0, 1, 0; sinx, 0, cosx];