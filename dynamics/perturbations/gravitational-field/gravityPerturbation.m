function g_sphr = gravityPerturbation(GM, Req, ...
                                        n, m, C, S, ...
...
sphrcoordsI = [0.95*Req, inf; 0, pi; 0, 2*pi];
...
% Don't account for Newtonian point-mass radial acceleration that would've
% followed as
%                   g_sphr(1) = g_sphr(1) + 1;
