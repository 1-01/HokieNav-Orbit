...
% 
% Matt Werner (m.werner@vt.edu) - Dec 01, 2020
% Matt Werner (m.werner@vt.edu) - Apr 11, 2021
% 
...
GMtype = convertCharsToStrings(GMtype);
...
if (N > 1000)
    error("Cannot supply degrees N exceeding 1000.")
end
...
if (M > 1000)
    warning("Changing order M to maximum order (1000).")
    M = 1000;
end
...
switch GMtype
    case "tide-free"
        load('mats/EGM2008/EGM2008GravityCoeff_TideFree_1000x1000.mat', '-mat', 'EGM2008GravityCoeff_TideFree_1000x1000');
        G = EGM2008GravityCoeff_TideFree_1000x1000;
        clear EGM2008GravityCoeff_TideFree_1000x1000 % Clear from memory (~24MB)
    otherwise
        error("Please use the tide-free (""tide-free"") gravitational model.")
end
